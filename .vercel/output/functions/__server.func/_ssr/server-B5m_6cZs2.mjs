...
import { i as __exportAll, n as createCsrfMiddleware } from "./server-B5m_6cZs.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-B_qz57Pn.mjs");
...
var manifest = {
	"077bc5ff90cc1f578c6597290e83048464fd42de4066d3cccf024c8080b55959": {
		functionName: "adminDeleteOrder_createServerFn_handler",
		importer: () => import("./admin.functions-C0N1zYiM.mjs")
	},
	"0aba47d27a6b467234d5b8b494d16bb446b7ca53f463ecbbd00e9a33a19ef0f3": {
	...
	"35f84d67dda2de6df81b7a43c7acdb0df007930bc74b903bb0d1784b68ab2349": {
		functionName: "adminSaveCategory_createServerFn_handler",
		importer: () => import("./admin.functions-C0N1zYiM.mjs")
	},
	"3c5ece365351dbd5cbb3f09730a1f03ea9785b5c10f82478b139e03ecf33002a": {
		functionName: "getOrderByReference_createServerFn_handler",
		importer: () => import("./shop.functions-BzhFi6CQ.mjs")
	},
	"4fc9dfb8da00d94592ccc4eb6f79d8c00a509e62b1662efcfa0746d07851d917": {
		functionName: "adminSaveDeliveryFees_createServerFn_handler",
		importer: () => import("./admin.functions-C0N1zYiM.mjs")
	},
	...
	"69a8504d74a18043e2ac882ac4ad35f0dcb299dd1afb2741f43c4c093ef738d0": {
		functionName: "getDeliveryFees_createServerFn_handler",
		importer: () => import("./shop.functions-BzhFi6CQ.mjs")
	},
	"889ae61040d9bd29926ab0915e752bccd669e918182aef01d6c23513a117ad85": {
		functionName: "adminSetOrderStatus_createServerFn_handler",
		importer: () => import("./admin.functions-C0N1zYiM.mjs")
	},
	"88d4492d68520da23c630e05ebd5be35f349083b918591673b6fac33c742169c": {
		functionName: "adminGetDeliveryFees_createServerFn_handler",
		importer: () => import("./admin.functions-C0N1zYiM.mjs")
	},
	...
	"a588f9e544729348735fe5bdfd638ab14f15e87d805702dc709b2dbb2474f92e": {
		functionName: "submitOrder_createServerFn_handler",
		importer: () => import("./shop.functions-BzhFi6CQ.mjs")
	},
	"ee3c33bb2bfb3a4224c48a7449cddde2e0585de0dd9a0f041e0cc2aea5871203": {
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DmPxCQ5i.mjs").then((n) => n.t),
		import("./start-DvlaNAXa.mjs"),
